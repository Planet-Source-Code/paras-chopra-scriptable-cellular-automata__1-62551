    ...
    With cell.code
        If GotoLine Then 'If Go To line is checked
            ...
            If lngStart = -1 Then 'Invalid line number
                MsgBox "Invalid line number!", vbInformation, "Cell Laboratory" 'Show message
            cell.add_info "Invalid line number!"
                Exit Sub
            End If
...
GoToError:
    If Err.Number = 13 Then
        MsgBox "You can only type numbers!!!", vbInformation, "Cell Laboratory" 'Show message
            cell.add_info "You can only type numbers!!!"
        Exit Sub
    End If
End Sub
